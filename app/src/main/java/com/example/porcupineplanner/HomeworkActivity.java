/**
 * This program computes the logic for editing a new Homework item or old Homework item. It uses intents
...
public class HomeworkActivity extends AppCompatActivity {
    ...
    /**
     * Sets up the logic for editing old Homework item
     *
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Passing an intent to MainActivity with the new Homework information
